        ...
        if NIM_LOGIN:
            while True:
                ...
                if pilih == 1:
                    ...
                    sbm.show_assignment_not_submit(
                        dict_activity, dict_submission, NIM_LOGIN)
                if pilih == 4:
                    sbm.submit_assignment(
                        dict_submission, list_topic, dict_activity, NIM_LOGIN)
                elif pilih == 5:
                    sbm.update_submission(
                        dict_submission, list_topic, dict_activity, NIM_LOGIN)
                elif pilih == 6:
                    sbm.delete_submission(
                        dict_submission, list_topic, dict_activity, NIM_LOGIN)
                elif pilih == 0:
                    NIM_LOGIN = ''
                    break
                ...
                if pilih == 1:
                    while True:
                        ...
                        if pilih2 == 1:
                            ...
                            mhs.delete_mhs(
                                dict_mhs, dict_submission, dict_grade)
                        elif pilih2 == 6:
                    ...
                    while True:
                        ...
                        if pilih2 == 1:
                            ...
                            LAST_ID_ACTIVITY = tpc.add_topic(
                                list_topic, dict_activity, LAST_ID_ACTIVITY)
                        elif pilih2 == 3:
                            tpc.update_topic(list_topic)
                        elif pilih2 == 4:
                            tpc.delete_topic(
                                list_topic, dict_activity, dict_submission, dict_grade)
                        elif pilih2 == 5:
                            LAST_ID_ACTIVITY = tpc.add_activity(
                                list_topic, dict_activity, LAST_ID_ACTIVITY)
                        elif pilih2 == 6:
                    ...
                    while True:
                        ...
                        pilih2 = int(input('Masukkan ID Menu: '))
                        if pilih2 == 1:
                            sbm.show_nim_not_submit(
                                dict_mhs, dict_submission, dict_activity)
                        elif pilih2 == 2:
                            sbm.print_submissions_to_file(
                                dict_submission, dict_activity)
                        elif pilih2 == 0:
                            break
                elif pilih == 4:
                    while True:
                        ...
                        if pilih2 == 1:
                            ...
                            gr.add_grade_by_mhs(
                                dict_submission, dict_activity, dict_grade)
                        elif pilih2 == 4:
                            gr.show_assignment_not_graded(
                                dict_submission, dict_activity, dict_grade)
                        elif pilih2 == 5:
                            gr.add_grade_by_assignment(
                                dict_submission, dict_grade)
                        elif pilih2 == 6:
                            gr.report_by_assignment(
                                dict_submission, dict_activity, dict_grade)
                        elif pilih2 == 7:
